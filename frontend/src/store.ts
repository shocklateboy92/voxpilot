...
import type { Session, Message, Part, MessageWithParts } from "./api-client"
...
export const [pendingPermission, setPendingPermission] = createSignal<PendingPermission | null>(null)
